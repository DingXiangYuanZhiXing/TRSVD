...
\text { LEMMA }  $$\mathcal{A} *(\mathcal{B} * \mathcal{C})=(\mathcal{A} * \mathcal{B}) * \mathcal{C}$$
...
\begin{algorithm}  
	...
	\begin{algorithmic} 
		...
		\For  {$p=1, \ldots, P, v=1, \ldots, V, i=1, \ldots, I, e=1, \ldots, E$}
		...
		\For  {$v=1, \ldots, V, i=1, \ldots, I, e=1, \ldots, E ; $}
